...
import step4.FourthRatings;

import java.util.ArrayList;
import java.util.List;

public class RecommendationRunner extends Object implements Recommender {

    public RecommendationRunner() {super();
    }
    ...
    public void printRecommendationsFor(String webRaterID){
        ...
        List<Rating> recList = fr.getSimilarRatings(webRaterID,numSimilarRaters,minimalRaters);
